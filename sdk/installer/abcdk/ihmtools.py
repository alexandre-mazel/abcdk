...
def choice( strQuestion, listChoice, rTimeOut = 12., nDefaultSelection = -1, bUseSpeechReco = True, bRepeatChoosenAnswer = True, bEnableWordSpotting = True, bActivateChoiceProposal = False, astrJointsToExclude = [], bUseDisplay =  True, listSpecificDisplay = None , bTrackFace = False):
    """
...
def askConfirmation( strQuestion, rTimeOut = 12., bAskConfirmation = False, bRepeatChoosenAnswer = True):
    ...
    retVal = choice( strQuestion, listChoice, rTimeOut, bRepeatChoosenAnswer = bRepeatChoosenAnswer, listSpecificDisplay = ["oui", "non"] );
    if( retVal != None ):
