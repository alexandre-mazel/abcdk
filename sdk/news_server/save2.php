...
$f_data=$yearOfAction.','.$monthOfAction.','.$weekDayOfAction.','.$dayOfAction.','.$hourOfAction.','.$minuteOfAction.','.$secondOfAction.','.$place.','.$source.','.$action.','.$cible.','.$objet.','.$actionDuration.','.$Keywords.',
 ' ;
